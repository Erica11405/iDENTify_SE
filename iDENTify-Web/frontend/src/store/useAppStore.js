...
//     }),
//     {
//       name: 'identify-auth-storage', // This is the key that saves it to your browser's memory
//     }
//   )
// );
...
const useAppStore = create(
  persist(
    ...
    {
      name: 'identify-auth-storage', // This is the key that saves it to your browser's memory
      // ADDED: partialize ensures we ONLY save the logged-in user to local storage. 
      // It stops the app from saving stale dentists/patients memory.

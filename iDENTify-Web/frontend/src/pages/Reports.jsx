...
// //   // NEW: Function to export specific Dentist Patient List to PDF
...
// //       doc.setFontSize(18);
// //       doc.text(`Patient List - ${selectedDentist.name}`, 14, 15);
...
// //         p.full_name,
// //         formatApptTime(p.appointment_datetime),
// //         p.reason || "Check-up"
// //       ]);
...
// //       const fileName = `Patients_${selectedDentist.name.replace(/\s+/g, '_')}_${selectedDate.toISOString().slice(0, 10)}.pdf`;
// //       doc.save(fileName);
// //     } catch (err) {
...
// //                           <td>{formatApptTime(p.appointment_datetime)}</td>
// //                           <td>{p.reason || "Check-up"}</td>
// //                         </tr>
// //                       ))}
// //                     </tbody>
// //                   </table>

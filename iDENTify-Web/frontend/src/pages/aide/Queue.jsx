...
//     // FIX: Changed from `/app/patient/...` to `/patients/...`
...
function Queue() {
  ...
  const handleAddWalkIn = async (patientData) => {
    try {
      ...
      if (!patientId) throw new Error("Failed to resolve patient ID");
      ...
      await api.addQueue({
        patient_id: patientId, // Now uses the correct existing patient ID
        appointment_id: null,
        dentist_id: dentistObj ? dentistObj.id : null,
        source: "walk-in",
        status: "Checked-In",

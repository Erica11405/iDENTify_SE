...
// // //     // Fetch saved year from LocalStorage, default to 1
...
// // //                 // Smart refresh logic for handling unsaved new years
...
// // //                 // ------------------------------------------------------------------
// // //                 // SMART AUTO-POPULATION LOGIC (Direct DB check + Strict Format)
// // //                 // ------------------------------------------------------------------
// // // 				if ((timeline || []).length === 0) {
                    
// // //                     // 1. Fetch appointments directly to survive page refreshes
...
// // //                     // 2. Locate the active appointment
...
// // //                     const cleanTime = now.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }); // Enforces "12:30 AM" (No seconds)

// // // 					if (linkedAppointment) {
// // //                         // 3. Extract procedures (handles strings and arrays)
// // //                         let procData = linkedAppointment.procedure || linkedAppointment.procedures || linkedAppointment.service || linkedAppointment.services || linkedAppointment.reason || linkedAppointment.dental_service || "";
...
// // // 						} else if (linkedAppointment.timeStart || linkedAppointment.time || linkedAppointment.appointment_time) {
// // //                             const timeStr = linkedAppointment.timeStart || linkedAppointment.time || linkedAppointment.appointment_time;
...
// // // 					} else {
// // //                         // Fallback: Use current exact time (no seconds) and empty procedure
// // //                         setTimelineForm({ start_time: `${cleanDate} ${cleanTime}` });
// // // 					    setSelectedTimelineServices([]);
// // //                     }
// // // 				} else {
// // //                     // For completely new manual entries after the first one is saved
// // //                     const now = new Date();
// // //                     const cleanDate = now.toLocaleDateString();
...
// //                 // FIX: Check if medical_alerts is a string before splitting
// //                 let alerts = [];
// //                 if (patientData.medical_alerts) {
...
//                 // --- SMART AUTO-POPULATION LOGIC (Procedures Fix) ---
// 				if ((timeline || []).length === 0) {
//                     let dbAppointments = allAppointments;
//                     if (!dbAppointments || dbAppointments.length === 0) {
//                         try {
...
// 					if (linkedAppointment) {
//                         // Support various field names for procedures
//                         let procData = linkedAppointment.procedure || linkedAppointment.procedures || linkedAppointment.reason || linkedAppointment.service || linkedAppointment.services || linkedAppointment.dental_service || "";

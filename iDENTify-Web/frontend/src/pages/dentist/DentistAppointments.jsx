...
//   // Fallback to 1 if no user is found during testing, but ideally it uses currentUser.id
//   const currentDentistId = currentUser?.id || 1; 
...
//                 // Format time properly just in case timeStart is missing

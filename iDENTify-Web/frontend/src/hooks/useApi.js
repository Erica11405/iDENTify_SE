...
// //   const removeDentistStore = useAppStore((s) => s.removeDentist);
...
// //         }
// //         return { ...appt, timeStart, patient: appt.full_name };
// //       });
...
// //   // FIXED: Added isHistory parameter to allow fetching full history
// //   const loadQueue = useCallback(async (isHistory = false) => {
// //     setLoading(true);
// //     try {
// //       // Ensure your apiClient.getQueue can accept the history flag
// //       const list = await api.getQueue(isHistory);
// //       setQueue(list);
// //       return list;
...
// //       if (removeDentistStore) removeDentistStore(id);
// //     },
// //     getPatientById,
// //     createPatient,
// //     updatePatient,
...
//   // ADDED: Missing updateQueueItem function
...
export default function useApi() {
  ...
  return useMemo(() => ({
    ...
    addQueue,
    updateQueueItem,
    // ADD THESE: Dynamic Services Hook integration
    getServices: async () => api.getServices(),
    createService: async (p) => api.createService(p),
    deleteService: async (id) => api.deleteService(id),
    getToothConditions: async (p, y) => api.getToothConditions(p, y),
    upsertToothCondition: async (p) => api.upsertToothCondition(p),
    getTreatmentTimeline: async (p, y) => api.getTreatmentTimeline(p, y),
    addTreatmentTimelineEntry: async (p) => api.addTreatmentTimelineEntry(p),
